  ...
  return (
    <div className="home-container">
      ...
      <div className="home-grid">
        ...
        <div className="grid-box grid-certificates grid-box-link">
          ...
          >
            <div className="grid-box-content p-0">
              <div class="two-line-button text-white">
                <div class="two-line-button-text-box px py">
                  <div className="textbox-inner">
                    <p class="button-sub-text text-small weight-700">
                      This website
                    </p>
                    <p class="button-main-text text-p">Source code</p>
                  </div>
                </div>
                <div class="arrow-container">
                  <div class="arrow pr-lg pl-lg">
                    <svg
                      viewBox="0 0 15 14"
                      fill="#ffffff"
                      xmlns="http://www.w3.org/2000/svg"
              ...
              <div class="two-line-button text-white">
                <div class="two-line-button-text-box px py">
                  <div className="textbox-inner">
                    ...
                    <p class="button-main-text text-p">Check Out My Resume</p>
                  </div>
                </div>
                <div class="arrow-container">
                  <div class="arrow pr-lg pl-lg">
        ...
        {stat.map((el) => (
          <div className={`grid-box ${el.gridClass} px py`}>
